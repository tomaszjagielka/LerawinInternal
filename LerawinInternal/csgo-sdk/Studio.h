...
//#define BONE_SCREEN_ALIGN_CYLINDER      0x10    // bone aligns to the screen, constrained by it'size own axis.
//
...
//    float                    parent;
//    float                    bonecontroller[6];    // bone controller index, -1 == none
//    Vector                 pos;
//    Quaternion             quat;
//    RadianEuler            rot;
//    // compression scale
...
//    float                    proctype;
//    float                    procindex;
//    mutable float            physicsbone;
//    inline void *pProcedure() const { if (procindex == 0) return NULL; else return  (void *)(((byte *)this) + procindex); };
//    float                    surfacepropidx;
//    inline char *const    pszSurfaceProp(void) const { return ((char *)this) + surfacepropidx; }
//    inline float             GetSurfaceProp(void) const { return surfacepropLookup; }
//
//    float                    contents;
//    float                    surfacepropLookup;
//    float                    m_iPad01[7];
//
//    mstudiobone_t() {}
//private:
...
//    }
//
//    mstudiobbox_t *GetHitbox(float i)
//    {
